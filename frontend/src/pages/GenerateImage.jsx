...
export default function GenerateImage() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(
        ...
        "-=0.4",
      ); // Start slightly before header finishes
    }, pageRef);
    return () => ctx.revert();
  }, []);
  ...
  return (
    <div
      ref={pageRef}
      className="min-h-screen bg-[#F9FAFB] font-sans relative overflow-hidden"
    >
      {/* Background Pattern */}
      <div
      ...
      <div className="relative z-10 px-4 py-12">
        ...
        <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
            ...
            <div className="rounded-2xl bg-white shadow-xl shadow-gray-200/50 ring-1 ring-gray-100 overflow-hidden">
              ...
              >
                ...
                <div className="p-5 border-b border-gray-50">
                  ...
                  <div className="p-5 border-b border-gray-50">
                    <Controller
                      name="resolution" // Wahi name jo aapke Zod schema mein hai
                      control={control} // handleSubmit wale 'useForm' hook se aata hai
                      render={({ field }) => (
                        <CustomSelect
                          options={IMAGE_RESOLUTION}
                          value={field.value} // Yeh form state se current value leta hai
                          onChange={field.onChange} // Jab dropdown change hoga, yeh form ko update karega
                        />
                      )}
                    />
                  </div>
                ...
                <div className="flex-1 p-5 bg-gray-50/30">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="flex items-center gap-1 px-2 py-1 text-[10px] font-medium text-purple-600 bg-purple-50 hover:bg-purple-100 rounded transition"
                        title="Random Prompt"
                      >
                        <div ref={diceRef}>
                          <Dice5 size={12} />
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full rounded-xl border border-gray-200 bg-white p-4 text-sm text-gray-900 placeholder:text-gray-400 focus:border-purple-500 focus:outline-none focus:ring-4 focus:ring-purple-500/10 transition-all resize-none shadow-sm"
                    />
                  ...
                  <button
                    ...
                    className="w-full mt-4 group relative flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-gray-900 to-gray-800 py-3.5 text-sm font-semibold text-white shadow-lg shadow-gray-900/20 transition-all hover:brightness-110 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
              ...
              {error && (
                <div className="px-5 pb-5 text-center text-sm text-red-500">
                  {error}
                </div>
              )}
            </div>
          ...
          <div className="gsap-panel lg:col-span-8 h-full">
            <div
              className={`h-full min-h-125 rounded-2xl bg-white shadow-xl shadow-gray-200/50 ring-1 ring-gray-100 transition-all duration-500 ${generatedImages ? "ring-2 ring-purple-500/20" : ""} flex flex-col overflow-hidden`}
            >
                ...
                {isSubmitting ? (
                  ...
                  <div className="gsap-result-image w-full flex flex-col items-center">
                    ...
                    <div className="flex w-full max-w-sm gap-3 mt-8">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-white border border-gray-200 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all shadow-sm"
                      >
                  ...
                  <div className="text-center max-w-sm">
                    ...
                    <p className="text-sm text-gray-500 leading-relaxed">
                      Configure your settings on the left and hit generate to
      ...
      <div className="relative py-8">
        ...
        <div className="relative flex justify-center">
          <span className="bg-[#F9FAFB] px-4 text-sm text-gray-400 flex items-center gap-2">
            <History size={16} /> Recent Generations
          </span>
        </div>
      </div>

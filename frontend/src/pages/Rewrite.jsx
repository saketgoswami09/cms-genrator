          ...
          <div className="flex flex-col h-full rounded-2xl bg-white shadow-xl shadow-gray-200/50 ring-1 ring-gray-100 overflow-hidden transition-shadow hover:shadow-2xl hover:shadow-gray-200/50">
            ...
            <form onSubmit={handleSubmit(formhandler)} className="flex-1 flex flex-col">
              <div className="flex-1 relative group bg-gray-50/30">
                <textarea
                  {...register("content")}
                  className="w-full h-full p-6 text-gray-800 placeholder:text-gray-400 text-base leading-relaxed resize-none focus:outline-none bg-transparent"
              ...
              <div className="p-5 bg-white border-t border-gray-100">
                <button
                  ...
                  className="w-full relative flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 transition-all hover:brightness-110 active:scale-[0.99] disabled:opacity-70"
                >
                  {isSubmitting ? (
                    <>
                  ...
                  {isSubmitting ? (
                    ...
                    <>
                        ...
                        <div className="result-actions mt-8 flex gap-3 pt-4 border-t border-gray-200/60">
                            <button onClick={handleCopy} className="flex-1 flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors shadow-sm">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-gray-300">
                        ...
                        <p className="text-sm font-medium text-gray-400">Waiting for content...</p>
                    </div>
                  )}
               </div>
            </div>
